...
print('dewpoint',dewpoint_data)
#print("lcl_pressure shape:", np.shape(lcl_pressure))
...
height_at_500hPa = interplevel(height, pres_data_3d, lcl_pressure[0].magnitude)[flash_location[1],flash_location[0]]
...
#ax.plot(qvapor_data * 1000, z_data, color='green')
